...
import { User, Mail, Shield, Trophy, LogOut, Edit2, Camera, Loader2 } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      formData.append('squadra', editData.squadra);
      if (avatarFile) {
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center mb-6">
                  ...
                  <div className="relative mb-4">
                    <div className="h-24 w-24 rounded-full bg-primary/20 flex items-center justify-center border-2 border-primary overflow-hidden">
                      {avatarUrl ? (
                ...
                <div className="mt-6 pt-6 border-t border-white/10 space-y-3">
                  <Dialog open={isEditing} onOpenChange={(open) => {
                    setIsEditing(open);
                    if (!open) { setAvatarFile(null); setAvatarPreview(null); }
                  }}>
                    ...
                    <DialogContent className="bg-card border-white/10">
                      ...
                      <form onSubmit={handleUpdateProfile} className="space-y-5 mt-4">
                        ...
                        <div className="flex flex-col items-center gap-3">
                          <div
                            className="relative h-24 w-24 rounded-full bg-primary/20 border-2 border-primary overflow-hidden cursor-pointer group"
                          ...
                          >
                            {avatarPreview ? (
                              ...
                              <User className="h-12 w-12 text-primary absolute inset-0 m-auto" />
                            )}
